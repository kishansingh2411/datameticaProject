...
#   Purpose:    : Functions to prepare incoming_stg2_vod_orders_mth_corp table in incoming layer
#                 1. Executes setup function to create incoming_stg2_vod_orders_mth_corp table incoming Layer.
...
function fn_module_setup(){
  ...
  fn_module_create_hive_table_data_layer_directory_structure \
    ...
    "${INCOMING_STG2_VOD_ORDERS_MTH_CORP_TBL}" \
    "${BOOLEAN_FALSE}" \
    "${log_file_path}"
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA}/${INCOMING_STG2_VOD_ORDERS_MTH_CORP_TBL}" \
     "${INCOMING_STG2_VOD_ORDERS_MTH_CORP_TBL}" \
