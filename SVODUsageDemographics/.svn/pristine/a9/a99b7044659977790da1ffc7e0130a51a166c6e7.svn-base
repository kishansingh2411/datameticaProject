...
--#   Purpose:    : Deriving the gold_d_vod_subscription_name table from incoming.
...
INSERT INTO TABLE ${hivevar:gold_database}.${hivevar:table_prefix}${hivevar:gold_table}
(
...
LEFT JOIN ${hivevar:gold_database}.${hivevar:table_prefix}${hivevar:gold_table} AS b ON (UPPER(TRIM(a.name)) = UPPER(TRIM(b.subscription_name)))
WHERE
