...
#   Purpose:    : Functions to prepare INCOMING_KOM_VOD_ORDER_TBL table in incoming layer
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA}/${INCOMING_KOM_VOD_ORDER_TBL}" \
     "${INCOMING_KOM_VOD_ORDER_TBL}" \
