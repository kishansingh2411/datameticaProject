...
public class KomCustomerAccountBulkEncryptor extends Configured implements Tool {
  ...
  private static String UAT_USER;
  private static String DEVICE;
  private static String OUTPUT_SCHEMA;

  private enum JOB_COUNTERS {
    KOM_CUSTOMER_ACCOUNT_RECORDS,
  }

  public static class MyMapper extends Mapper<LongWritable,KomCustomerAccountDBInputWritable,Text,NullWritable> {
    @Override
    public void map(LongWritable key, KomCustomerAccountDBInputWritable value, Context context) throws IOException, InterruptedException {
  ...
  public static class MyReducer extends Reducer<Text,NullWritable,AvroKey<GenericRecord>,NullWritable> {
  ...
  private void cleanup( Configuration conf, String[] args) throws IOException {
