...
/**
 * Util class contains the common utility functions used across various classes.
 *
 * @author Kriti Singh
 */
public final class Util {
  ...
  public static void deleteLogFiles( Configuration conf, String dir) throws IOException
  {
  ...
  public static Map<String, String> getSchema() throws Exception {
		...
		try {
			...
			String propsFileName = "svodusagedemographics.properties";
			InputStream input = Util.class.getClassLoader().getResourceAsStream(propsFileName);
			if (input == null) {
			...
			System.out.println("Got filepath n nameNodeService as : "+filePath+ " : "+nameNodeService);
			if(filePath!=null && !filePath.equals("") && nameNodeService!=null && !nameNodeService.equals("")){
				...
				System.out.println("Found file path ["+filePath+"] and nameNodeService ["+nameNodeService+"]");
  ...
  private static Map<String, String> getSchemaDetails(String schemaFilePath, String nameNodeService) throws Exception {
		...
		try{
			...
			System.out.println("creating url : "+"hdfs://"+nameNodeService+"/"+schemaFilePath+"/svodusagedemographics-schema.properties");
