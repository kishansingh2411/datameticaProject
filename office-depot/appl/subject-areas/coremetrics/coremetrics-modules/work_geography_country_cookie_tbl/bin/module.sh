...
# File: module.sh                                                            #
#                                        	   								 #
# Description: Joining Geography Data with Cookie Data in work layer.		 #
#                                                                   		 #
...
##############################################################################
#																			 #
# ### Calling Pig Script to move data from gold to work layer				 #
#		Taking two parameters												 #
#		1. Table name  2. Root directory						 			 #
#																			 #
##############################################################################

fn_pig_wrapper $WORK_GEOGRAPHY_COUNTRY_COOKIE $1
