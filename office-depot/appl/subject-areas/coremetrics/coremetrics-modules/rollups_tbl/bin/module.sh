...
#     : module.sh                                   	                              #
# Description                                                                         #
#     : Loading data from outgoing layer to HBase tables 		  					  #
#                                                                                     #
#                                                                                     #
#                                                                                     #
# Author                                                                              #
...
##############################################################################
#																			 #
# Calling function to load data from work layer to outgoing layer		     #
#		Taking two parameters												 #
#		1. Table name  2. Record Type    						 			 #
#																			 #
##############################################################################

fn_pig_wrapper $ROLLUPS $1
