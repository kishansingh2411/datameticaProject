...
--#                                                                            		    #
--# Name                                                                                #
--#     : work_cdmprddta_dm_be          								   	 		    #
--# File                                                                                #
--#     : work_cdmprddta_dm_be.hql                                      	            #
--# Description                                                                         #
...
set mapred.job.name=${hiveconf:JOB_WORK_CDMPRDDTA_DM_BE_SSH_ACTION};
INSERT INTO TABLE ${hiveconf:DB_WORK}.${hiveconf:TBL_WORK_CDMPRDDTA_DM_BE}
