...
--#                                                                            		    #
--# Name                                                                                #
--#     : work_cdmprddta_dm_it          								   	 		    #
--# File                                                                                #
--#     : work_cdmprddta_dm_it.hql                                      	            #
--# Description                                                                         #
...
set mapred.job.name=${hiveconf:JOB_WORK_CDMPRDDTA_DM_IT_SSH_ACTION};
INSERT INTO TABLE ${hiveconf:DB_WORK}.${hiveconf:TBL_WORK_CDMPRDDTA_DM_IT}
