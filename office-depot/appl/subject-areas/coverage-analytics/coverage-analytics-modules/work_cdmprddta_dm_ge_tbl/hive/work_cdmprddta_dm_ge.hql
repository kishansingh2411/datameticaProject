...
--#                                                                            		    #
--# Name                                                                                #
--#     : work_cdmprddta_dm_ge          								   	 		    #
--# File                                                                                #
--#     : work_cdmprddta_dm_ge.hql                                      	            #
--# Description                                                                         #
...
set mapred.job.name=${hiveconf:JOB_WORK_CDMPRDDTA_DM_GE_SSH_ACTION};
INSERT INTO TABLE ${hiveconf:DB_WORK}.${hiveconf:TBL_WORK_CDMPRDDTA_DM_GE}
