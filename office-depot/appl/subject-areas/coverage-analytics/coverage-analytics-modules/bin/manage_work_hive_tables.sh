...
# File                                                                       #
#     : manage_work_hive_tables.sh                                   	     #
# Description                                                                #
#     : Manage Databse Schema and tables for Work layers.                    #
#                                                                            #
#                                                                            #
#                                                                            #
# Author                                                                     #
...
jobName=$MANAGE_WORK_SCHEMA_SSH_ACTION
...
fn_manage_hive_tbl "$debug_mode" "${logFilePath}" "manage_work_hive_tables"
