...
--#                                                                            		    #
--# Name                                                                                #
--#     : work_cdmprddta_dm_nl          								   	 		    #
--# File                                                                                #
--#     : work_cdmprddta_dm_nl.hql                                      	            #
--# Description                                                                         #
...
set mapred.job.name=${hiveconf:JOB_WORK_CDMPRDDTA_DM_NL_SSH_ACTION};
INSERT INTO TABLE ${hiveconf:DB_WORK}.${hiveconf:TBL_WORK_CDMPRDDTA_DM_NL}
