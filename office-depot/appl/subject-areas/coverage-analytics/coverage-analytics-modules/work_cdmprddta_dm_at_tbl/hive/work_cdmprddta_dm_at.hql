...
--#                                                                            		    #
--# Name                                                                                #
--#     : work_cdmprddta_dm_at          								   	 		    #
--# File                                                                                #
--#     : work_cdmprddta_dm_at.hql                                      	            #
--# Description                                                                         #
...
set mapred.job.name=${hiveconf:JOB_WORK_CDMPRDDTA_DM_AT_SSH_ACTION};
INSERT INTO TABLE ${hiveconf:DB_WORK}.${hiveconf:TBL_WORK_CDMPRDDTA_DM_AT}
