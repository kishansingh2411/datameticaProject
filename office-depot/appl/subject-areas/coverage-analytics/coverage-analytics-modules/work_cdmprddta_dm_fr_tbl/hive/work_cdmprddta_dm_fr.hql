...
--#                                                                            		    #
--# Name                                                                                #
--#     : work_cdmprddta_dm_fr          								   	 		    #
--# File                                                                                #
--#     : work_cdmprddta_dm_fr.hql                                      	            #
--# Description                                                                         #
...
set mapred.job.name=${hiveconf:JOB_WORK_CDMPRDDTA_DM_FR_SSH_ACTION};
INSERT INTO TABLE ${hiveconf:DB_WORK}.${hiveconf:TBL_WORK_CDMPRDDTA_DM_FR}
