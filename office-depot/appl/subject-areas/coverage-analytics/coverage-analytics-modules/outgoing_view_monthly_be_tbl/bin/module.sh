...
# File: module.sh                                                            #
#                                        	   								 #
# Description: Loading data in outgoing layer.						         #
#                                                                   		 #
# Author: Shweta Karwa 					                                     #
#                                                                            #
##############################################################################
...
#																			 #
##############################################################################
country_code_be=$(echo $country_code_be | tr 'A-Z' 'a-z')
TABLE_NAME=$HBASE_TBL"_"$country_code_be
fn_pig_wrapper "$TABLE_NAME" "$1"
