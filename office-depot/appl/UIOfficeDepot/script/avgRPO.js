...
(function($)
 {
    ...
    /*Average Revenue by order Function*/
       //Format Data For Average Rvenue Per Order
     $.formatAvgRPO =function(data)
    {
    //  log(data);
      try{
...
//       log("Data By Country Formatted");
   //   log(formatedData);
    ...
    catch(e)
    {
     ...
     $.structCommonAvgRpo =function(data)
    {
    //  log(data);
      try{
       var formatedData = new Array();
...
//       log("Data By Country Formatted");
 ...
 $.getStructAvgRpoForChart= function(dataCompute)
{
...
*/       
        ...
        var avgPro =totalRevenue/totalOrders;
...
/*get Ind Country*/
    ...
    /*Get List of Selected Countries Data in Format Used For
    Deciding country selection from dropdown
    */
    $.displayByCountryChartAvgPro =function(countryOrder,formattedDataGlobal)
    {
...
*/         tempObj.pointHighlightFill ='rgb(' + (Math.floor(Math.random() * 256)) + ',' + (Math.floor(Math.random() * 256)) + ',' + (Math.floor(Math.random() * 256)) +')';
        ...
        {  
         ...
         //OCR Compute totalOrders/totalVisits
          var ocr =totalRevenue/totalOrders;  
    ...
    $.formatToStackChartDataAvgRpo  = function(serialData)
    {
      ...
      /*  if(isNA)
        {  
          ocrNA = parseFloat(serialData.NA[loop].totalRevenue/serialData.NA[loop].totalOrders);
        }
*/
