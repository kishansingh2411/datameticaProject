 ...
 */
@RequestValidation
public class CoverageAnalyticsRequest implements Request {
  ...
  @Dimension(message = "INVALID_DIMENSION", module = Module.COVERAGEANALYTICS)
  private String dimensions;

  @NotBlank(message = "METRICS_NOT_AVAILABLE")
  @Metric(message = "INVALID_METRIC", module = Module.COVERAGEANALYTICS)
  private String metrics;

  @Filters(message = "INVALID_FILTER", module = Module.COVERAGEANALYTICS)
  ...
  public Module getModule() {
    return Module.COVERAGEANALYTICS;
  }

  @Override
  public String toString() {
    return "CoverageAnalyticsRequest [fromDate=" + fromDate + ", toDate=" + toDate + ", dimensions=" + dimensions + ", metrics=" + metrics
