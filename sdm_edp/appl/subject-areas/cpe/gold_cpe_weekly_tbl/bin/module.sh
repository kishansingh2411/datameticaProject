...
#   Purpose:    : Functions to prepare gold_cpe_weekly table in gold layer
#                 1. Executes setup function to create gold_cpe_weekly table in Gold Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_CPE_WEEKLY_TBL}" \
     "${GOLD_CPE_WEEKLY_TBL}" \
...
#Transforming gold_cpe_weekly table at gold layer
