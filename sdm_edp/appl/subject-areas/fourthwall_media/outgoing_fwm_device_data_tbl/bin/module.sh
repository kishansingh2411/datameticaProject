...
#   Purpose:    : Functions to prepare outgoing_fwm_device_data table in Outgoing layer
#                 1. Executes setup function to create outgoing_fwm_device_data table in Outgoing Layer.
...
function fn_module_setup(){
  ...
  fn_module_create_hive_table_data_layer_directory_structure \
    ...
    "${OUTGOING_FWM_DEVICE_DATA_TBL}" \
    "${BOOLEAN_FALSE}" \
    "${log_file_path}"
}

#Transforming outgoing_fwm_device_data table at outgoing layer
function fn_module_transform(){
  ...
  dir_path="${DATA_LAYER_DIR_OUTGOING_SUBJECT_AREA}/${OUTGOING_FWM_DEVICE_DATA_TBL}/${file_type}/p_yyyymmdd=${source_date}/"
