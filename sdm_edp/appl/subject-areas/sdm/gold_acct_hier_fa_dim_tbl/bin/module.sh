...
#   Purpose:    : Functions to prepare gold_acct_hier_fa_dim table in Gold layer
#                 1. Executes setup function to create gold_acct_hier_fa_dim table in Gold Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_ACCT_HIER_FA_DIM_TBL}" \
     "${GOLD_ACCT_HIER_FA_DIM_TBL}" \
