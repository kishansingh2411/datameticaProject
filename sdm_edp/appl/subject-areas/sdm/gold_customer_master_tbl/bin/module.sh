...
#   Purpose:    : Functions to prepare gold_customer_master table in Gold layer
#                 1. Executes setup function to create gold_customer_master table in Gold Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_CUSTOMER_MASTER_TBL}" \
     "${GOLD_CUSTOMER_MASTER_TBL}" \
...
#Transforming gold_customer_master table at gold layer
