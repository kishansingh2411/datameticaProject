...
then
    job_name="EDP_SDM_${key_param_id}_ACC_HIER_LD_GD"
elif [[ $table_name == "customer_master" ]]
then
    job_name="EDP_SDM_${key_param_id}_CUST_MAS_LD_GD"
elif [[ $table_name == "customer_services" ]]
then
    job_name="EDP_SDM_${key_param_id}_CUST_SER_LD_GD"
elif [[ $table_name == "equipment_dtls" ]]
then
    job_name="EDP_SDM_${key_param_id}_EQUI_DTL_LD_GD"
elif [[ $table_name == "equipment_master" ]]
then
    job_name="EDP_SDM_${key_param_id}_EQUI_MAS_LD_GD"
elif [[ $table_name == "house_master" ]]
then
    job_name="EDP_SDM_${key_param_id}_HOUS_MAS_LD_GD"
elif [[ $table_name == "item_dtl" ]]
then
    job_name="EDP_SDM_${key_param_id}_ITEM_DTL_LD_GD"
elif [[ $table_name == "item_master" ]]
then
    job_name="EDP_SDM_${key_param_id}_ITEM_MAS_LD_GD"
elif [[ $table_name == "srv_dim" ]]
then
    job_name="EDP_SDM_${key_param_id}_SRV_DIM_LD_GD"
elif [[ $table_name == "customer" ]]
then
    job_name="EDP_SDM_${key_param_id}_CUSTOMER_LD_GD"
elif [[ $table_name == "equipment" ]]
then
    job_name="EDP_SDM_${key_param_id}_EQUIPMNT_LD_GD"                    
else
