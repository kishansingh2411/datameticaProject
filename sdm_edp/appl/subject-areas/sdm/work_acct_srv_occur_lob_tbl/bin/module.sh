...
#   Purpose:    : Functions to prepare work_acct_srv_occur_lob table in Work layer
#                 1. Executes setup function to create work_acct_srv_occur_lob table in Work Layer.
#                    Input Arguments for this script are: Phase name (setup), Log file path(/log/file/path)  
#                 2. Executes transform function to build Work table.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_ACCT_SRV_OCCUR_LOB_TBL}" \
     "${WORK_ACCT_SRV_OCCUR_LOB_TBL}" \
...
#Transforming work_acct_srv_occur_lob table at Work layer
