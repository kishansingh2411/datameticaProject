...
#   Department: AM
#
#   Program name: footprints_functions.sh  
#   Program type: Unix Bash Shell script
#   Purpose:    : This script consists of all the utility functions that are used by    
#                 footprints module scripts. Modules shall not call and hadoop related commands    
...
################################################################################
#                                                                              #
# Function to update footprints params                                         #
#                                                                              #
################################################################################

function fn_update_footprints_params(){
...
################################################################################
#                                                                              #
# Function to get key params for Footprints      							   #
#                                                                              #
################################################################################

function fn_get_footprints_params(){
   key_param_id=$1
