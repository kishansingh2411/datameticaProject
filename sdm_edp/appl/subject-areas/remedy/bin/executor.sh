...
##############################################################################
#                                                                            #
# Load Outgoing Layer outgoing_export_node_srvgrp                            #
#                                                                            #
##############################################################################
...
success_message="Successfully loaded table outgoing_export_node_srvgrp at Outgoing layer"  
failure_message="Failed to load data in table outgoing_export_node_srvgrp at Outgoing layer, Quitting the process." 
fn_handle_exit_code "${exit_code}" "${success_message}" "${failure_message}" "${BOOLEAN_TRUE}" "${executor_log_file}"

##############################################################################
#                                                                            #
# Export data to MySQL table export_node_srvgrp                              #
#                                                                            #
##############################################################################

sh $SUBJECT_AREA_HOME/bin/load_mysql_table.sh $key_param_id
exit_code=$?

success_message="Successfully exported data to MySQL table export_node_srvgrp"  
failure_message="Failed while exporting data to MySQL table export_node_srvgrp, Quitting the process." 
fn_handle_exit_code "${exit_code}" "${success_message}" "${failure_message}" "${BOOLEAN_TRUE}" "${executor_log_file}"
