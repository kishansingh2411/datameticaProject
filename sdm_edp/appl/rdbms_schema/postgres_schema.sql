...
;
INSERT INTO KEY_PARAMS VALUES
    (600033,'600033','LOAD OVCDR OV TELEPHONE NMBR DATA','2016-12-14','2016-12-14','',null,24,0,DATE_TRUNC('SECOND',NOW()::TIMESTAMP),null)
;

INSERT INTO KEY_PARAMS VALUES
    (600034,'600034','LOAD SDM DATA','2016-12-14','2016-12-14','','',24,0,DATE_TRUNC('SECOND',NOW()::TIMESTAMP),null)
;

INSERT INTO KEY_PARAMS VALUES
    (600035,'600035','LOAD REMEDY DATA','2016-12-14','2016-12-14','remedy','',24,0,DATE_TRUNC('SECOND',NOW()::TIMESTAMP),null)
;

INSERT INTO KEY_PARAMS VALUES
    (600036,'600036','LOAD IVR DATA','2016-12-14','2016-12-14','ivr','',24,0,DATE_TRUNC('SECOND',NOW()::TIMESTAMP),null)
;

INSERT INTO KEY_PARAMS VALUES
    (600037,'600037','LOAD FOURTHWALL_MEDIA DATA','2016-12-14','2016-12-14','fwm','',24,0,DATE_TRUNC('SECOND',NOW()::TIMESTAMP),null)
;

INSERT INTO KEY_PARAMS VALUES
    (600038,'600038','LOAD CPE DATA','2016-12-14','2016-12-14','cpe','',24,0,DATE_TRUNC('SECOND',NOW()::TIMESTAMP),null)
;

INSERT INTO KEY_PARAMS VALUES
    (600040,'600040','LOAD FOOTPRINTS DATA','2016-12-14','2016-12-14','footprints','',24,0,DATE_TRUNC('SECOND',NOW()::TIMESTAMP),null)
;
