...
#   Purpose:    : Functions to prepare gold_customer_service_groups table in Gold layer
#                 1. Executes setup function to create gold_customer_service_groups table in Gold Layer.
...
function fn_module_setup(){
  ...
  fn_module_create_hive_table_data_layer_directory_structure \
    ...
    "${GOLD_CUSTOMER_SERVICE_GROUPS_TBL}" \
    "${BOOLEAN_FALSE}" \
    "${log_file_path}"
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_CUSTOMER_SERVICE_GROUPS_TBL}" \
     "${GOLD_CUSTOMER_SERVICE_GROUPS_TBL}" \
...
#Transforming gold_customer_service_groups table at Gold layer
