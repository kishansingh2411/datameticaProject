...
#   Purpose:    : Functions to prepare incoming_cpe_model_info table in Incoming layer
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA}/${INCOMING_CPE_MODEL_INFO_TBL}" \
     "${INCOMING_CPE_MODEL_INFO_TBL}" \
...
#Preparing incoming_cpe_model_info table at incoming layer
function fn_module_prepare(){
  ...
  fn_copy_from_local \
     "${SUBJECT_AREA_HOME}/metadata/Cpe_Model_Info.txt" \
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA}/${INCOMING_CPE_MODEL_INFO_TBL}" \
     "${BOOLEAN_FALSE}" \
     "${BOOLEAN_FALSE}" \
     "${log_file_path}"
