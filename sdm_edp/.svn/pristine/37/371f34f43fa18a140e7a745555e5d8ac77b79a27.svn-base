...
do
      ...
      then
   	      fn_log_error "Failed to copy file ${source_file} to HDFS directory ${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA}/${INCOMING_CDR_RESI_TBL}/p_yyyymmdd=${source_date}" "${log_file_path}"	
          return $exit_code
      fi
      fn_log_info "Successfully copied file ${source_file} to HDFS directory ${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA}/${INCOMING_CDR_RESI_TBL}/p_yyyymmdd=${source_date}" "${log_file_path}"
done  
