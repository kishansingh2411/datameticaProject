...
#   Department: AM
#
#   Program name: fourthwall_media_functions.sh  
#   Program type: Unix Bash Shell script
#   Purpose:    : This script consists of all the utility functions that are used by    
#                 fourthwall_media module scripts. Modules shall not call and hadoop related commands    
...
################################################################################
#                                                                              #
# Function to update fourthwall_media params                                   #
#                                                                              #
################################################################################

function fn_update_fourthwall_media_params(){
...
################################################################################
#                                                                              #
# Function to get key params for Fourthwall_media  							   #
#                                                                              #
################################################################################

function fn_get_fourthwall_media_params(){
   key_param_id=$1
