...
#   Purpose:    : Functions to prepare gold_srv_dim_tbl table in Gold layer
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_SRV_DIM_TBL}" \
     "${GOLD_SRV_DIM_TBL}" \
...
#Transforming gold_srv_dim table at gold layer
