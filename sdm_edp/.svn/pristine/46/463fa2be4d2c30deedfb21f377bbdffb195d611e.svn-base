...
#   Purpose:    : Functions to prepare outgoing_export_cmts_node table in Outgoing layer
#                 1. Executes setup function to create outgoing_export_cmts_node table in Outgoing Layer.
...
function fn_module_prepare(){
  ...
  dir_path="${DATA_LAYER_DIR_OUTGOING_SUBJECT_AREA}/${OUTGOING_EXPORT_CMTS_NODE_TBL}/p_yyyymmdd=${source_date}/"
