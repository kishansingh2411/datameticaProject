...
#   Purpose:    : Functions to prepare gold_item_dtl table in Gold layer
#                 1. Executes setup function to create gold_item_dtl table in Gold Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_ITEM_DTL_TBL}" \
     "${GOLD_ITEM_DTL_TBL}" \
...
#Transforming gold_item_dtl table at gold layer
