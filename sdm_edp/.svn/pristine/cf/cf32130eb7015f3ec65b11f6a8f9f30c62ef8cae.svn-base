...
#   Department: AM
#
#   Program name: update_key_params.sh
...
#   ------   --------------------     ----------       -------------------------------------
#    1.0     DataMetica Team          02/28/2017       Initial version
#
#
#####################################################################################################################
...
job_name="EDP_CPE_"${key_param_id}"_UPT_KEY_PARMS"
...
fn_update_cpe_params ${key_param_id}
exit_code=$?
