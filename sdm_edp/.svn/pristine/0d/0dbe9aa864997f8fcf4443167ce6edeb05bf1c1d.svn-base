...
#   Purpose:    : Functions to prepare gold_equipment_dtls table in Gold layer
#                 1. Executes setup function to create gold_equipment_dtls table in Gold Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_EQUIPMENT_DTLS_TBL}" \
     "${GOLD_EQUIPMENT_DTLS_TBL}" \
...
#Transforming gold_equipment_dtls table at gold layer
