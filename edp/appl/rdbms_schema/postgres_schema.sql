...
INSERT INTO KEY_PARAMS VALUES
    (600033,'600033','LOAD OVCDR CUSTOMER ACCOUNT DATA','2016-12-14','2016-12-14','',null,24,0,DATE_TRUNC('SECOND',NOW()::TIMESTAMP),null)
;

INSERT INTO EDP_AUDIT VALUES
   ('OVCDR','customer_account',0,0,NULL,'1900-01-01','1900-01-01')
;

INSERT INTO EDP_AUDIT VALUES
   ('OVCDR','ov_telephone_number',0,0,NULL,'1900-01-01','1900-01-01')
;

-- Additional entries as part of BHV ehancement

CREATE SEQUENCE BHV_ACC_PHONE_NBR_OPT_SEQ 
   INCREMENT BY 1
   MINVALUE 100
;

CREATE SEQUENCE BHV_ACC_PHONE_NBR_SDL_SEQ 
   INCREMENT BY 1
   MINVALUE 100
;
