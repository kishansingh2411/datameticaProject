...
#                    and create gold_t_f_bm_dhcp_ip_tbl in gold layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_T_F_BM_DHCP_IP_TBL}" \
     "${GOLD_T_F_BM_DHCP_IP_TBL}" \
...
# Deriving gold_t_f_bm_dhcp_ip_tbl table at gold layer
function fn_module_transform(){
  ...
  hive_script_path="${MODULE_HOME}/hive/module-transform.hql"
   ...
   -hivevar gold_t_f_bm_dhcp_ip_tbl=${HIVE_TABLE_PREFIX}$GOLD_T_F_BM_DHCP_IP_TBL \
   -hivevar incoming_ext_t_f_bm_dhcp_ip_tbl=${HIVE_TABLE_PREFIX}$INCOMING_EXT_T_F_BM_DHCP_IP_TBL \
   -hivevar source_date=$formatted_source_date \
