...
#   Purpose:    : Functions to prepare Browser table in Incoming layer
#                 1. Executes setup function to create Browser table in Incoming Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_BROWSER_TBL}" \
     "${INCOMING_BROWSER_TBL}" \
...
#Transforming the Browser table at Incoming layer
