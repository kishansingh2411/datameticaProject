...
--#   Purpose:    : Loading data from incoming_hit_data table to gold_opt_hit_data_esp
...
SPLIT incoming_hit_data_filter 
	INTO hit_data_with_mandatory_records
   	IF (
        ...
        AND post_visid_high is not null AND TRIM(post_visid_high) !='' 
        AND post_visid_low is not null AND TRIM(post_visid_low) !='' 
...
hit_data_decrypted_records = 
	...
	GENERATE
	   ...
	   ..
	   evar22,
	   encryptDecrypt('$suite_name', 'TTT_ACCT_NUMBER','$username', evar23, 'DECRYPT') AS evar23_ttt_acct_number,
	   evar24,
	   evar25,
	   evar26,
	   evar27
       ...
       prop9,
	   prop10,
	   encryptDecrypt('$suite_name', 'OPTIMUM_ID','$username', prop11, 'DECRYPT') AS prop11_optimum_id,
	   prop12
	   ..
	   prop24,
...
hit_data_decrypted_records_missing_optimumId_with_ttt_acct_number_generated = 
	...
	GENERATE        
		...
		..		
		zip,
		SUBSTRING(hit_data_decrypted_records.evar23_ttt_acct_number, 1, 5)  AS corp,
		SUBSTRING(hit_data_decrypted_records.evar23_ttt_acct_number, 6, 6)  AS cust,
		SUBSTRING(hit_data_decrypted_records.evar23_ttt_acct_number, 12, 2) AS dwelling_nbr,
		-1                                                                  AS optimum_user_id
;
...
STORE generated_records
   INTO '${hive_database_name_gold}.${gold_opt_hit_data_esp_tbl}' 
