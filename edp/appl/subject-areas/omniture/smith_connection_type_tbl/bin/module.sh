...
#                    and create smith_connection_type_tbl in smith layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_CONNECTION_TYPE_TBL}" \
     "${SMITH_CONNECTION_TYPE_TBL}" \
...
# Deriving connection type table at Smith layer
...
#        -hivevar smith_connection_type_tbl="${SMITH_CONNECTION_TYPE_TBL}" \
#        -hivevar hive_database_name_incoming="${HIVE_DATABASE_NAME_INCOMING}" \
#		-hivevar incoming_connection_type_tbl="${INCOMING_CONNECTION_TYPE_TBL}" \
