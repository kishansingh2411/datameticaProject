...
--#   Purpose:    : Create Work table(work_cust_service_last_rec_tbl)
--#   Author(s)   : DataMetica Team
--#   Usage       : beeline -u  <url> -n <username> -p <password> -hivevar var1=var1 -f module.hql
--#   Date        : 05/05/2016
--#   Log File    : .../log/ods/ODS_DEPLOYMENT.log
--#   SQL File    : 
--#   Error File  : .../log/ods/ODS_DEPLOYMENT.log
--#   Dependency  : 
--#   Disclaimer  : 
--#
...
ID_CUST                         INT    COMMENT '',
CH_ACCOUNT_NUMBER             VARCHAR(20)  COMMENT '',
