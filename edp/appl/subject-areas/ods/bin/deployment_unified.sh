...
#        		  6. Creating Hive Tables for all layers
...
log_file_path=$LOG_DIR_SUBJECT_AREA/ODS_DEPLOYMENT.log
...
hdfs_dirs=("${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_SHOPPING_CART}")
...
tables=($SUBJECT_AREA_HOME/incoming_ecr9_shopping_cart_tbl)
