...
#   Usage       : load_work_ovcdr_modules.sh  
#   Date        : 12/18/2016
...
fn_log_info "Successfully fetched last_updated_date ${last_updated_date} from ${EDP_AUDIT} for table ${target_table_work}" "${log_file_path}"  
