...
--#   Purpose:    : Create Work table(work_tmp_rsdvr_requests_tbl)
...
(
 ...
 SAVE_DAYS_INCOMING      DECIMAL(5, 0),
 STATUS_INCOMING       BIGINT,
 SHORT_TITLE_INCOMING   VARCHAR(128),
 DS_STARTTIME_INCOMING   TIMESTAMP,
 LAST_UPDATED_INCOMING   TIMESTAMP,
