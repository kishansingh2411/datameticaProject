...
#                 1. Executes setup function to prepare work_rsdvr_requests_tbl table in incoming layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA_STAGING}/${WORK_RSDVR_SCHEDULE_TBL}" \
     "${WORK_RSDVR_SCHEDULE_TBL}" \
...
#Preparing incoming_rsdvr_schedule table.
  ...
  source_table="$1"
  log_file_path="$2"
  target_dir="${DATA_LAYER_DIR_WORK_SUBJECT_AREA_STAGING}/${WORK_RSDVR_SCHEDULE_TBL}/*"

  query="$(fn_build_query_for_import ${source_table} ${COL_RSDVR_SCHEDULE})"
 ...
 #Sqoop INCOMING_RSDVR_REQUESTS table data
