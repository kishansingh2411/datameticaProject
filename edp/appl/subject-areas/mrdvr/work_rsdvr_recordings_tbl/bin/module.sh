...
#                 1. Executes setup function to prepare work_rsdvr_recordings_tbl table in incoming layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA_STAGING}/${WORK_RSDVR_RECORDINGS_TBL}" \
     "${WORK_RSDVR_RECORDINGS_TBL}" \
...
#Preparing incoming_rsdvr_recordings table.
...
function fn_module_prepare(){
  ...
  target_dir="${DATA_LAYER_DIR_WORK_SUBJECT_AREA_STAGING}/${WORK_RSDVR_RECORDINGS_TBL}/*"

  query="$(fn_build_query_for_import ${source_table} "${COL_RSDVR_RECORDINGS}")"
 ...
 #Sqoop work_rsdvr_recordings table data
