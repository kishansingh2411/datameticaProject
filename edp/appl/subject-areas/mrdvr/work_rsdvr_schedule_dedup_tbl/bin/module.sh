...
#                 1. Executes setup function to prepare work_rsdvr_schedule_dedup_tbl table in work layer.
#                               Input Arguments for this script are: Phase name (setup), Log file path(/log/file/path)                                                                               
#                 2. Executes transform function to prepare work_rsdvr_schedule_dedup_tbl table in work layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_SCHEDULE_DEDUP_TBL}" \
     "${WORK_RSDVR_SCHEDULE_DEDUP_TBL}" \
...
#Preparing work_rsdvr_schedule_dedup_tbl table.
function fn_module_transform(){
    ...
    target_dir="${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_SCHEDULE_DEDUP_TBL}/*"
...
beeline -u ${HIVESERVER2_URL} -n ${HIVE_USENAME} -p ${HIVE_PASSWORD} \
      ...
      -hivevar work_rsdvr_schedule_seq_tbl=${WORK_RSDVR_SCHEDULE_SEQ_TBL} \
