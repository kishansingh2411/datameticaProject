...
--#   Purpose:    : Loading data from work_rsdvr_requests_tmp_tbl table to work_rsdvr_preferences_seq_tbl table
...
work_tmp_data = 
	LOAD '${hive_database_name_work}.${work_rsdvr_requests_tmp_tbl}'
...
generated_records = 
	...
	GENERATE ..op_type_u,
		SeqGen( '${table_name}' , '${namenode_service}') as rsdvr_requests_delta_seq
;
...
STORE generated_records
	INTO '${hive_database_name_work}.${work_rsdvr_requests_seq_tbl}' 
