...
--#   Purpose:    : Build work_rsdvr_requests_delete table 
...
INSERT OVERWRITE TABLE ${hivevar:hive_database_name_work}.${hivevar:work_rsdvr_requests_delete_tbl}
SELECT 
	WORK_RSDVR_REQUESTS_TMP.SCHEDULE_ID_INCOMING                    AS SCHEDULE_ID,
	WORK_RSDVR_REQUESTS_TMP.HOME_ID_INCOMING                        AS HOME_ID,
	WORK_RSDVR_REQUESTS_TMP.SERIAL_NUMBER_INCOMING                  AS SERIAL_NUMBER,
	WORK_RSDVR_REQUESTS_TMP.MODIFIED_TIME_INCOMING                   AS MODIFIED_TIME,
	'D'                                                             AS OP_TYPE,
...
ON
	...
	GOLD_RSDVR_REQUESTS_LAST_REC.SERIAL_NUMBER = WORK_RSDVR_REQUESTS_TMP.SERIAL_NUMBER_INCOMING)
	
WHERE
	GOLD_RSDVR_REQUESTS_LAST_REC.OP_TYPE !='D'
AND 
