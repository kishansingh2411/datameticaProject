...
--#   Purpose:    : Loading data from work_rsdvr_recordings_archive_tbl to incoming_rsdvr_recordings_archive_tbl table
...
work_data_encrypted_records = FOREACH work_data_distinct 
        GENERATE 
        id_schedule,
        id_asset,
