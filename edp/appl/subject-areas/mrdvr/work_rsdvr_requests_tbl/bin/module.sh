...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA_STAGING}/${WORK_RSDVR_REQUESTS_TBL}" \
     "${WORK_RSDVR_REQUESTS_TBL}" \
...
#Preparing incoming_rsdvr_requests table.

function fn_module_prepare(){

  source_table="$1"
  log_file_path="$2"
  target_dir="${DATA_LAYER_DIR_WORK_SUBJECT_AREA_STAGING}/${WORK_RSDVR_REQUESTS_TBL}/*"

  query="$(fn_build_query_for_import ${source_table} ${COL_RSDVR_REQUESTS})"
