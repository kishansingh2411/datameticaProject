...
(
   ...
   PROGRAM_CLASSIFICATION          VARCHAR(20)     			COMMENT 'This is derived data substr(TF_DATABASE_KEY,1,2).  Sourced from first two characters of the TMS_DATABASE_KEY.  Domain ''MV''  Movie ''SH''  Showing ''EP''  Episod ''SP''  Sport',
