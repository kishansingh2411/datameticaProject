...
#                 1. Executes setup function to prepare gold_t_f_split_ipchannel_tuning_tbl table in incoming layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA_FACT}/${GOLD_T_F_SPLIT_IPCHANNEL_TUNING_TBL}" \
     "${GOLD_T_F_SPLIT_IPCHANNEL_TUNING_TBL}" \
...
#Preparing gold_t_f_split_ipchannel_tuning_tbl table.
