...
#                    and create incoming_custrates_tbl in incoming layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_DATA}/${INCOMING_CUSTRATES_TBL}" \
     "${INCOMING_CUSTRATES_TBL}" \
...
#Preparing INCOMING_CUSTRATES user table.
function fn_module_prepare(){
 ...
 #Sqoop EDP_CUSTRATES_TBL table data
