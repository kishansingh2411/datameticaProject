...
#                 1. Executes setup function to prepare incoming_wipmaster_tbl table in incoming layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_DATA}/${INCOMING_WIPMASTER_TBL}" \
     "${INCOMING_WIPMASTER_TBL}" \
...
#Preparing incoming EDP_WIPMASTER_TBL table.
...
function fn_module_prepare(){
 ...
 #Sqoop EDP_WIPMASTER_TBL table data
