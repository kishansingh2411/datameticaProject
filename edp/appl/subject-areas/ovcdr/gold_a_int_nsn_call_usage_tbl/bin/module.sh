...
#                    and create a_int_nsn_call_usage in gold layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_A_INT_NSN_CALL_USAGE_TBL}" \
     "${GOLD_A_INT_NSN_CALL_USAGE_TBL}" \
...
#Preparing gold_a_int_nsn_call_usage_tbl  table.
