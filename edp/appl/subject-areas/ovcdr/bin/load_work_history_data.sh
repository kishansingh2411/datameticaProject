...
then
    job_name="EDP_${key_param_id}_WK_VMA_NSN_CALL"
elif [[ $table_name == "a_dom_nsn_out_usage" ]]
then
    job_name="EDP_${key_param_id}_WK_DOM_NSN_OUT"	
elif [[ $table_name == "a_int_rad_call_usage" ]]
  then
    job_name="EDP_${key_param_id}_WK_INT_RAD_CALL"
elif [[ $table_name == "a_int_nsn_call_usage" ]]
then
    job_name="EDP_${key_param_id}_WK_INT_NSN_CALL"
elif [[ $table_name == "a_dom_nsn_in_usage" ]]
then
    job_name="EDP_${key_param_id}_WK_DOM_NSN_IN"
else
