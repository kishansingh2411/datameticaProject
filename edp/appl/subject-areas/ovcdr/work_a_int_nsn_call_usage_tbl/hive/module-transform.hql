...
GOLD_UPDATE AS (
   SELECT 
      ...
      SRC_GOLD_1.PRODUCT_NAME,
	  SRC_GOLD_1.PLAN_NUMBER,
   ...
   ON (
      ...
      AND SRC_GOLD_1.PRODUCT_NAME = SRC_WORK_1.PRODUCT_NAME
      AND SRC_GOLD_1.PLAN_NUMBER = SRC_WORK_1.PLAN_NUMBER
      AND SRC_GOLD_1.BATCH_NBR = SRC_WORK_1.BATCH_NBR
      AND SRC_GOLD_1.ATTEMPT_COUNT = SRC_WORK_1.ATTEMPT_COUNT
      AND SRC_GOLD_1.TERM_COUNTRY = SRC_WORK_1.TERM_COUNTRY
      )
   WHERE
