...
function fn_module_setup(){
  ...
  fn_module_create_hive_table_data_layer_directory_structure \
    ...
    "${WORK_RSDVR_PREFERENCES_SEQ_TBL}" \
    "${BOOLEAN_FALSE}" \
    "${log_file_path}"
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_PREFERENCES_SEQ_TBL}" \
     "${WORK_RSDVR_PREFERENCES_SEQ_TBL}" \
...
#Preparing work_rsdvr_preferences_seq_tbl table.
function fn_module_transform(){
	...
	target_dir="${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_PREFERENCES_SEQ_TBL}/*"
    ...
    pig -useHCatalog -Ddfs.blocksize=${DFS_BLOCKSIZE} \
      ...
      -p work_rsdvr_preferences_tmp_tbl=${WORK_RSDVR_PREFERENCES_TMP_TBL} \
      -p work_rsdvr_preferences_seq_tbl=${WORK_RSDVR_PREFERENCES_SEQ_TBL} \
