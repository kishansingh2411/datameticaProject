...
#                    and create smith_operating_systems_tbl in smith layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_OPERATING_SYSTEMS_TBL}" \
     "${SMITH_OPERATING_SYSTEMS_TBL}" \
...
# Deriving operating systems table at Smith layer
...
#        -hivevar dtm_created="$dtm_created" \
 #       -hivevar hive_database_name_smith="${HIVE_DATABASE_NAME_SMITH}" \
  #      -hivevar smith_operating_systems_tbl="${SMITH_OPERATING_SYSTEMS_TBL}" \
   #     -hivevar hive_database_name_incoming="${HIVE_DATABASE_NAME_INCOMING}" \
	#	-hivevar incoming_operating_systems_tbl="${INCOMING_OPERATING_SYSTEMS_TBL}" \
