...
#   Purpose:    : Module script to load gold vow hit data table
#                 1. Executes setup function to prepare directory structure for the table											                                						  
#                    and create gold_vow_hit_data_tbl in gold layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_VOW_HIT_DATA_TBL}" \
     "${GOLD_VOW_HIT_DATA_TBL}" \
...
# Deriving vow hit data table at Gold layer
