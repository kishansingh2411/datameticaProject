...
#                    and create work_raterptctrs_tbl in work layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA_DATA}/${WORK_RATERPTCTRS_TBL}" \
     "${WORK_RATERPTCTRS_TBL}" \
...
#Preparing incoming EDP_RATERPTCTRS_TBL table.
function fn_module_prepare(){   
 ...
 #Sqoop EDP_RATERPTCTRS_TBL table data
   ...
   then
      fn_log_error "Failed while recreating the table ${WORK_RATERPTCTRS_TBL}" "${log_file_path}"
      return $exit_code
   fi
