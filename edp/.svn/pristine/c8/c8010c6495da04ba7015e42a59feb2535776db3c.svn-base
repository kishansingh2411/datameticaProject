...
tables=("${INCOMING_OV_TELEPHONE_NUMBER_TBL}_tbl" \
        "${INCOMING_CUSTOMER_ACCOUNT_TBL}_tbl" \
        "${INCOMING_IP_SIP_DID_PHONE_NBR_TBL}_tbl" \
        "${INCOMING_IP_SIP_PILOT_PHONE_NBR_TBL}_tbl" \
        "${WORK_OV_TELEPHONE_NUMBER_TBL}_tbl" \
        "${WORK_CUSTOMER_ACCOUNT_TBL}_tbl")
