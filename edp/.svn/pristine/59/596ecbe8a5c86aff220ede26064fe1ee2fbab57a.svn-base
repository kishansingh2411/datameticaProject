...
then
 job_name="ODS_${key_param_id}_LD_WRK_TELEPHN_NMBR"
 log_file_dir=${LOG_DIR_SUBJECT_AREA}/customer
 batch_id_dir="$BATCH_ID_DIR_SUBJECT_AREA/customer"
 
elif [ "${table_name}" == "cutomer_account" ]
 then
  job_name="ODS_${key_param_id}_LD_WRK_CUST_ACCNT"
  log_file_dir=${LOG_DIR_SUBJECT_AREA}/customer
  batch_id_dir="$BATCH_ID_DIR_SUBJECT_AREA/customer"
 
elif [ "${table_name}" == "ip_sip_did_phone_nbr" ]
 then
  job_name="ODS_${key_param_id}_LD_WRK_DID_PHN_NBR"
  log_file_dir=${LOG_DIR_SUBJECT_AREA}/customer
  batch_id_dir="$BATCH_ID_DIR_SUBJECT_AREA/customer"
 
elif [ "${table_name}" == "ip_sip_pilot_phone_nbr" ]
 then
  job_name="ODS_${key_param_id}_LD_WRK_PILT_PHN_NBR"
  log_file_dir=${LOG_DIR_SUBJECT_AREA}/customer
  batch_id_dir="$BATCH_ID_DIR_SUBJECT_AREA/customer"
fi
