...
--#   Purpose:    : Create Gold table(gold_t_f_split_ipchannel_tuning_tbl)
...
(    
   ...
   HOUSEHOLD_IPDEVICE_ID         INT       COMMENT '',
   ...
   SRC_CHANNEL_NAME              VARCHAR(15)    COMMENT '',
   AS_USER_ID                    BIGINT      COMMENT '',
   APP_VERSION                   VARCHAR(10)    COMMENT '',
   AS_CHANNEL_TUNING_ID          BIGINT      COMMENT '',
...
PARTITIONED BY (SEGMENT_DATE DATE)
STORED AS ORC
