...
#                    and create incoming_custmaster_tbl in incoming layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_DATA}/${INCOMING_CUSTMASTER_TBL}" \
     "${INCOMING_CUSTMASTER_TBL}" \
...
#Preparing incoming EDP_CUSTMASTER table.
...
function fn_module_prepare(){
  ...
  #Sqoop EDP_CUSTMASTER table data
