...
--#   Purpose:    : Create Incoming table(incoming_t_cvb_f_split_mrdvr_usage_tbl)
...
(  
   SPLIT_MRDVR_USAGE_ID            BIGINT   	COMMENT '',
   ...
   STB_ASSET_ID                    BIGINT   	COMMENT '',
   REMOTE_CONTROL_KEY_ID           INT   		COMMENT '',
   DTM_ACTIVITY_START              TIMESTAMP   	COMMENT '',
