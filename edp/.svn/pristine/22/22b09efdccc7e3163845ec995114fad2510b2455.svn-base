...
#                    and create smith_plugins_tbl in smith layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_PLUGINS_TBL}" \
     "${SMITH_PLUGINS_TBL}" \
...
# Deriving plugins table at Smith layer
...
#		-hivevar smith_plugins_tbl="${SMITH_PLUGINS_TBL}" \
#		-hivevar hive_database_name_incoming="${HIVE_DATABASE_NAME_INCOMING}" \
#		-hivevar incoming_plugins_tbl="${INCOMING_PLUGINS_TBL}" \
