...
#   Purpose:    : Functions to prepare Languages table in Incoming layer
#                 1. Executes setup function to create Languages table in Incoming Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_LANGUAGES_TBL}" \
     "${INCOMING_LANGUAGES_TBL}" \
...
#Transforming the Languages table at Incoming layer
