...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static final String OFFSET_DB_CONNECTION_URL_CONFIG = "offset.db.connection.url";
  ...
  public static final String QUERY_HINT = "query.hint";
  
  public static final String QUERY_ADDITIONAL_CONDITION= "query.additional.condition";
  
  public static final String TOPICS_CONFIG = "topics";
  
  private static final String TOPICS_DOC =
	      "List of comma-separated Kafka topic names in the same order in which the database table names are mentioned";
  ...
  public static ConfigDef baseConfigDef() {
    return new ConfigDef()
        ...
        .define(INCREMENTING_COLUMN_NAME_CONFIG, Type.LIST, INCREMENTING_COLUMN_NAME_DEFAULT,
                Importance.MEDIUM, INCREMENTING_COLUMN_NAME_DOC)
        .define(TIMESTAMP_COLUMN_NAME_CONFIG, Type.LIST, TIMESTAMP_COLUMN_NAME_DEFAULT,
        ...
        .define(TOPIC_PREFIX_CONFIG, Type.STRING, TOPIC_PREFIX_DEFAULT,
                Importance.HIGH, TOPIC_PREFIX_DOC)
        .define(OFFSET_DB_CONNECTION_URL_CONFIG, Type.STRING, Importance.HIGH, null)
        .define(QUERY_HINT, Type.STRING, "", Importance.LOW, "")
        .define(QUERY_ADDITIONAL_CONDITION, Type.STRING, "", Importance.LOW, "")
