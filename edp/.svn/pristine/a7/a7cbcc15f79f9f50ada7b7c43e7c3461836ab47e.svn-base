...
#                 1. Executes setup function to prepare work_rsdvr_recordings_archive_seq table in work layer.
...
function fn_module_setup(){
  ...
  fn_module_create_hive_table_data_layer_directory_structure \
    ...
    "${WORK_RSDVR_RECORDINGS_ARCHIVE_SEQ_TBL}" \
    "${BOOLEAN_FALSE}" \
    "${log_file_path}"
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_RECORDINGS_ARCHIVE_SEQ_TBL}" \
     "${WORK_RSDVR_RECORDINGS_ARCHIVE_SEQ_TBL}" \
...
#Preparing work_rsdvr_recordings_archive_seq_tbl table.
function fn_module_transform(){
	...
	target_dir="${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_RECORDINGS_ARCHIVE_SEQ_TBL}/*"
    ...
    pig -useHCatalog -Ddfs.blocksize=${DFS_BLOCKSIZE} \
      ...
      -p work_rsdvr_recordings_archive_tmp_tbl=${WORK_RSDVR_RECORDINGS_ARCHIVE_TMP_TBL} \
      -p work_rsdvr_recordings_archive_seq_tbl=${WORK_RSDVR_RECORDINGS_ARCHIVE_SEQ_TBL} \
