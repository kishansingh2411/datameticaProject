...
#                 1. Executes setup function to prepare gold_rsdvr_requests_archive_delta_tbl table in gold layer.
...
function fn_module_setup(){
  ...
  fn_module_create_hive_table_data_layer_directory_structure \
    ...
    "${GOLD_RSDVR_REQUESTS_ARCHIVE_DELTA_TBL}" \
    "${BOOLEAN_FALSE}" \
    "${log_file_path}"
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_RSDVR_REQUESTS_ARCHIVE_DELTA_TBL}" \
     "${GOLD_RSDVR_REQUESTS_ARCHIVE_DELTA_TBL}" \
...
#Preparing gold_rsdvr_requests_archive_delta table.
...
beeline -u ${HIVESERVER2_URL} -n ${HIVE_USENAME} -p ${HIVE_PASSWORD} \
      ...
      -hivevar gold_rsdvr_requests_archive_delta=${GOLD_RSDVR_REQUESTS_ARCHIVE_DELTA_TBL} \
...
#Preparing gold_rsdvr_requests_archive_delta_tbl table.
