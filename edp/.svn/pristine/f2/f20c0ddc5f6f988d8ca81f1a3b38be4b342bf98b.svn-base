...
#                    and create smith_referrer_type_tbl in smith layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_REFERRER_TYPE_TBL}" \
     "${SMITH_REFERRER_TYPE_TBL}" \
...
# Deriving referrer type table at Smith layer
...
# 		-hivevar dtm_created="$dtm_created" \
 #       -hivevar hive_database_name_smith="${HIVE_DATABASE_NAME_SMITH}" \
	#	-hivevar smith_referrer_type_tbl="${SMITH_REFERRER_TYPE_TBL}" \
	#	-hivevar hive_database_name_incoming="${HIVE_DATABASE_NAME_INCOMING}" \
	#	-hivevar incoming_referrer_type_tbl="${INCOMING_REFERRER_TYPE_TBL}" \
