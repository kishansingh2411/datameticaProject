...
then
 job_name="EDP_ODS_${key_param_id}_LD_IN_PHN_NBR"
 ...
 then
  job_name="EDP_ODS_${key_param_id}_LD_IN_CUST_ACC"
  log_file_dir=${LOG_DIR_SUBJECT_AREA}/customer
  batch_id_dir="$BATCH_ID_DIR_SUBJECT_AREA/customer"
  
elif [ "${table_name}" == "ip_sip_did_phone_nbr" ]
 then
  job_name="EDP_ODS_${key_param_id}_LD_IN_DID_NBR"
  log_file_dir=${LOG_DIR_SUBJECT_AREA}/customer
  batch_id_dir="$BATCH_ID_DIR_SUBJECT_AREA/customer"
 
elif [ "${table_name}" == "ip_sip_pilot_phone_nbr" ]
 then
  job_name="EDP_ODS_${key_param_id}_LD_IN_PILT_NBR"
  log_file_dir=${LOG_DIR_SUBJECT_AREA}/customer
  batch_id_dir="$BATCH_ID_DIR_SUBJECT_AREA/customer"
fi
