...
#                    and create gold_a_dom_nsn_out_usage_tbl in gold layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_A_DOM_NSN_OUT_USAGE_TBL}" \
     "${GOLD_A_DOM_NSN_OUT_USAGE_TBL}" \
...
#Preparing gold_a_dom_nsn_out_usage_tbl  table.
