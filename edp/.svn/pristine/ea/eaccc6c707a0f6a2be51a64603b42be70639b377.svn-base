...
SELECT 
	...
	if(if(COALESCE(INCOMING_RSDVR_PREFERENCES.CREATE_TIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.CREATE_TIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0 OR (GOLD_RSDVR_PREFERENCES_LAST_REC.OP_TYPE ='D' AND to_date(INCOMING_RSDVR_PREFERENCES.LOADTIME) = to_date('${hivevar:dtm_end}')),'Y','N' ) as CREATE_TIME_IND,
	...
	if(GOLD_RSDVR_PREFERENCES_LAST_REC.HOME_ID is not null AND (if(COALESCE(INCOMING_RSDVR_PREFERENCES.SORT_OPTION,-1) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.SORT_OPTION,-1),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.SPACE_ALLOTTED,-1) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.SPACE_ALLOTED,-1),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.SPACE_USED,-1) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.SPACE_USED,-1),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.AUTO_ERASE,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.AUTO_ERASE,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.SAVE_DAYS,-1) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.SAVE_DAYS,-1),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.NODE_ID,-1) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.NODE_ID,-1),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.BLOCK_TITLES,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.BLOCK_TITLES,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.STATUS,-1) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.STATUS,-1),1,0) = 0  OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.CREATE_TIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.CREATE_TIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.STATUS_CHANGED,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) =COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.STATUS_CHANGED,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.INGESTS_ALLOTED,-1) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.INGESTS_ALLOTED,-1),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.VERSION1,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.VERSION1,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.REC_PAST_FOLDERS,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.REC_PAST_FOLDERS,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.REC_EPISODE_KEEP,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.REC_EPISODE_KEEP,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.REC_EPISODE_QUALITY,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.REC_EPISODE_QUALITY,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.REC_EPISODE_STOP,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.REC_EPISODE_STOP,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.REC_SERIES_KEEP,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.REC_SERIES_KEEP,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.REC_SERIES_QUALITY,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.REC_SERIES_QUALITY,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.REC_SERIES_STOP,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.REC_SERIES_STOP,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.REC_SERIES_SAVE_NUM_EP,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.REC_SERIES_SAVE_NUM_EP,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.REC_SERIES_TYPE,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.REC_SERIES_TYPE,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.RECORDER_ID,-1) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.RECORDER_ID,-1),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.CREATED_BY,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.CREATED_BY,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.MODIFY_TIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.MODIFY_TIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.MODIFIED_BY,'*') = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.MODIFIED_BY,'*'),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_PREFERENCES.LAST_UPDATED,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) = COALESCE(GOLD_RSDVR_PREFERENCES_LAST_REC.LAST_UPDATED,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0 OR (GOLD_RSDVR_PREFERENCES_LAST_REC.OP_TYPE = 'D' AND to_date(INCOMING_RSDVR_PREFERENCES.LOADTIME) = to_date('${hivevar:dtm_end}')) ),TRUE,FALSE ) as CHANGEDFLAG,
