...
#                 1. Executes setup function to create work_rsdvr_recordings_seq table in work layer.
#               		Input Arguments for this script are: Phase name (setup), Log file path(/log/file/path)                 										  
#                 2. Executes transform function to load work_rsdvr_recordings_seq table in work layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_RECORDINGS_SEQ_TBL}" \
     "${WORK_RSDVR_RECORDINGS_SEQ_TBL}" \
...
#Preparing work_rsdvr_recordings_seq_tbl table.
function fn_module_transform(){
	...
	target_dir="${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_RECORDINGS_SEQ_TBL}/*"
    ...
    pig -useHCatalog -Ddfs.blocksize=${DFS_BLOCKSIZE} \
      ...
      -p work_rsdvr_recordings_tmp_tbl=${WORK_RSDVR_RECORDINGS_TMP_TBL} \
      -p work_rsdvr_recordings_seq_tbl=${WORK_RSDVR_RECORDINGS_SEQ_TBL} \
