...
#                    and create gold_a_int_rad_call_usage in gold layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_A_INT_RAD_CALL_USAGE_TBL}" \
     "${GOLD_A_INT_RAD_CALL_USAGE_TBL}" \
...
#Preparing gold_a_int_rad_call_usage_tbl  table.
