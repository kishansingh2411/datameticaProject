...
#   Purpose:    : Functions to prepare Referrer_type table in Incoming layer
#                 1. Executes setup function to create Referrer_type table in Incoming Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_REFERRER_TYPE_TBL}" \
     "${INCOMING_REFERRER_TYPE_TBL}" \
...
#Transforming referrer_type table at incoming layer
