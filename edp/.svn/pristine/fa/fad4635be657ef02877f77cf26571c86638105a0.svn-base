...
#   Purpose:    : Module script to load gold unified hit data table
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_UNIFIED_HIT_DATA_TBL}" \
     "${GOLD_UNIFIED_HIT_DATA_TBL}" \
...
# Deriving unified hit data table at Gold layer
function fn_module_transform(){
    ...
    pig -useHCatalog -p suite_name=$suite_name \
		...
		-p gold_unified_hit_data_tbl="${HIVE_TABLE_PREFIX}${GOLD_UNIFIED_HIT_DATA_TBL}" \
