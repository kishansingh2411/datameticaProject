...
#                    and create work_ratecodes_tbl in work layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA_DATA}/${WORK_RATECODES_TBL}" \
     "${WORK_RATECODES_TBL}" \
...
function fn_module_prepare(){   
 ...
 #Sqoop EDP_RATECODES_TBL table data
   ...
   then
      fn_log_error "Failed while recreating the table ${WORK_RATECODES_TBL}" "${log_file_path}"
      return $exit_code
   fi
