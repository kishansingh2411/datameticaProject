...
#                    and create work_auxhouse_tbl in work layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA_DATA}/${WORK_AUXHOUSE_TBL}" \
     "${WORK_AUXHOUSE_TBL}" \
...
#Preparing incoming EDP_AUXHOUSE_TBL table.
function fn_module_prepare(){   
 ...
 #Sqoop EDP_AUXHOUSE_TBL table data
   ...
   then
      fn_log_error "Failed while recreating the table ${WORK_AUXHOUSE_TBL}" "${log_file_path}"
      return $exit_code
   fi
