...
--#   Purpose:    : Create Work table(work_rsdvr_preferences_delete_dedup_tbl)
...
(  
	SCHEDULE_ID                     VARCHAR(255)   COMMENT 'home id of the requesting box',
	HOME_ID                     VARCHAR(255)   COMMENT 'macaddress of the requesting box',
