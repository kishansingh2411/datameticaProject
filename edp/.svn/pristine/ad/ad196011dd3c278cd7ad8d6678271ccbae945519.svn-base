...
#   Date        : 04/12/2016
#   Log File    : .../log/mrdvr/MRDVR_600006_BATCH_ID_GEN.log
#   SQL File    :                                 
#   Error File  : .../log/mrdvr/MRDVR_600006_BATCH_ID_GEN.log
#   Dependency  : 
#   Disclaimer  :  
#
...
job_name="EDP_MRDVR_600006_BATCH_ID_GEN"
key_param_id="$1"
...
fn_local_create_directory_if_not_exists "${LOG_DIR}/${SUBJECT_AREA_NAME}" "${BOOLEAN_TRUE}" "${log_file_path}"
