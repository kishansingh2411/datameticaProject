...
#                 1. Executes setup function to prepare gold_t_cvb_f_split_mrdvr_usage_tbl table in incoming layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA_FACT}/${GOLD_T_CVB_F_SPLIT_MRDVR_USAGE_TBL}" \
     "${GOLD_T_CVB_F_SPLIT_MRDVR_USAGE_TBL}" \
...
#Preparing gold_t_cvb_f_split_mrdvr_usage_tbl table.
