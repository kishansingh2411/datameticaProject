...
--#   Purpose:    : Loading data from work_rsdvr_recordings_tmp_tbl table to work_rsdvr_recordings_seq_tbl table
...
work_tmp_data = 
	LOAD '${hive_database_name_work}.${work_rsdvr_recordings_tmp_tbl}'
...
STORE generated_records
	INTO '${hive_database_name_work}.${work_rsdvr_recordings_seq_tbl}' 
