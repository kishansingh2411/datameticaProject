...
#                    and create smith_country_tbl in smith layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_COUNTRY_TBL}" \
     "${SMITH_COUNTRY_TBL}" \
...
# Deriving Country table at Smith layer
...
#        -hivevar dtm_created="$dtm_created" \
 #       -hivevar hive_database_name_smith="${HIVE_DATABASE_NAME_SMITH}" \
  #      -hivevar smith_country_tbl="${SMITH_COUNTRY_TBL}" \
   #     -hivevar hive_database_name_incoming="${HIVE_DATABASE_NAME_INCOMING}" \
	#	-hivevar incoming_country_tbl="${INCOMING_COUNTRY_TBL}" \
