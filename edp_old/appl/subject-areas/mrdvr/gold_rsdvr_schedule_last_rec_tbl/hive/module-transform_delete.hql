...
INSERT OVERWRITE TABLE ${hivevar:hive_database_name_gold}.${hivevar:gold_rsdvr_schedule_last_rec} 
select 
...
,case when WORK_RSDVR_SCHEDULE_DELETE_DEDUP.CALLSIGN IS NOT NULL AND WORK_RSDVR_SCHEDULE_DELETE_DEDUP.STARTDATE IS NOT NULL AND WORK_RSDVR_SCHEDULE_DELETE_DEDUP.STARTTIME IS NOT NULL AND WORK_RSDVR_SCHEDULE_DELETE_DEDUP.DURATION IS NOT NULL then WORK_RSDVR_SCHEDULE_DELETE_DEDUP.OP_TYPE else GOLD_RSDVR_SCHEDULE_LAST_REC.OP_TYPE end as OP_TYPE
, GOLD_RSDVR_SCHEDULE_LAST_REC.DTM_CREATED  as DTM_CREATED
,case when WORK_RSDVR_SCHEDULE_DELETE_DEDUP.CALLSIGN IS NOT NULL AND WORK_RSDVR_SCHEDULE_DELETE_DEDUP.STARTDATE IS NOT NULL AND WORK_RSDVR_SCHEDULE_DELETE_DEDUP.STARTTIME IS NOT NULL AND WORK_RSDVR_SCHEDULE_DELETE_DEDUP.DURATION IS NOT NULL then WORK_RSDVR_SCHEDULE_DELETE_DEDUP.RSDVR_SCHEDULE_DELTA_SEQ else GOLD_RSDVR_SCHEDULE_LAST_REC.RSDVR_SCHEDULE_DELTA_SEQ end as RSDVR_SCHEDULE_DELTA_SEQ
,case when WORK_RSDVR_SCHEDULE_DELETE_DEDUP.CALLSIGN is not null and WORK_RSDVR_SCHEDULE_DELETE_DEDUP.STARTDATE is not null and WORK_RSDVR_SCHEDULE_DELETE_DEDUP.STARTTIME is not null and WORK_RSDVR_SCHEDULE_DELETE_DEDUP.DURATION is not null  then current_timestamp  else GOLD_RSDVR_SCHEDULE_LAST_REC.DTM_LAST_MODIFIED end  as DTM_LAST_MODIFIED
,case when WORK_RSDVR_SCHEDULE_DELETE_DEDUP.CALLSIGN is not null and WORK_RSDVR_SCHEDULE_DELETE_DEDUP.STARTDATE is not null and WORK_RSDVR_SCHEDULE_DELETE_DEDUP.STARTTIME is not null and WORK_RSDVR_SCHEDULE_DELETE_DEDUP.DURATION is not null then  current_timestamp  else GOLD_RSDVR_SCHEDULE_LAST_REC.DTM_LAST_UPDATED end  as DTM_LAST_UPDATED
,GOLD_RSDVR_SCHEDULE_LAST_REC.LOAD_DATE as LOAD_DATE	
FROM 
 ${hivevar:hive_database_name_gold}.${hivevar:gold_rsdvr_schedule_last_rec} GOLD_RSDVR_SCHEDULE_LAST_REC FULL OUTER JOIN ${hivevar:hive_database_name_work}.${hivevar:work_rsdvr_schedule_delete_dedup} WORK_RSDVR_SCHEDULE_DELETE_DEDUP   
ON 
