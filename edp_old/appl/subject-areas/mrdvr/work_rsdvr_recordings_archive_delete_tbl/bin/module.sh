...
#                 1. Executes setup function to prepare gold_rsdvr_recordings_archive_delta_tbl table in gold layer.
...
function fn_module_setup(){
  ...
  fn_module_create_hive_table_data_layer_directory_structure \
    ...
    "${WORK_RSDVR_RECORDINGS_ARCHIVE_DELETE_TBL}" \
    "${BOOLEAN_FALSE}" \
    "${log_file_path}"
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_RECORDINGS_ARCHIVE_DELETE_TBL}" \
     "${WORK_RSDVR_RECORDINGS_ARCHIVE_DELETE_TBL}" \
...
#Preparing work_rsdvr_recordings_archive_delete_tbl table.
