...
SELECT
	...
	VERSION1_INCOMING AS VERSION1,
    REC_PAST_FOLDERS_INCOMING AS REC_PAST_FOLDERS,
    REC_EPISODE_KEEP_INCOMING AS REC_EPISODE_KEEP,
    REC_EPISODE_QUALITY_INCOMING AS REC_EPISODE_QUALITY,
    REC_EPISODE_STOP_INCOMING AS REC_EPISODE_STOP,
    REC_SERIES_KEEP_INCOMING AS REC_SERIES_KEEP,
    REC_SERIES_QUALITY_INCOMING As REC_SERIES_QUALITY,
    REC_SERIES_STOP_INCOMING AS REC_SERIES_STOP,
    REC_SERIES_SAVE_NUM_EP_INCOMING AS REC_SERIES_SAVE_NUM_EP,
    REC_SERIES_TYPE_INCOMING AS REC_SERIES_TYPE,
    RECORDER_ID_INCOMING AS RECORDER_ID,
    CREATED_BY_INCOMING AS CREATED_BY,
    MODIFY_TIME_INCOMING AS MODIFY_TIME,
    MODIFIED_BY_INCOMING AS MODIFIED_BY,
