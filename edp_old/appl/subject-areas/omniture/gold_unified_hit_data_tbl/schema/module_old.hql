...
--#   Purpose:    : Create gold_unified_hit_data table in Gold layer
...
(
   ...
   EVAR10_OPTIMUM_LINK         	  VARCHAR(256) COMMENT '',
   EVAR11                   	  VARCHAR(255) COMMENT '',
   EVAR12_LIVE_CHAT_CLICK      	  VARCHAR(255) COMMENT '',
   ...
   EVAR19_SITE_LANGUAGE        	  VARCHAR(255) COMMENT '',
   EVAR2_PAGE_TYPE             	  VARCHAR(255) COMMENT '',
   EVAR20                     	  VARCHAR(255) COMMENT '',
   EVAR21                     	  VARCHAR(255) COMMENT '',
   EVAR22_FORM_ID              	  VARCHAR(255) COMMENT '',
   EVAR23                   	  VARCHAR(255) COMMENT '',
   EVAR24                   	  VARCHAR(255) COMMENT '',
   EVAR25                     	  VARCHAR(255) COMMENT '',
   EVAR26_EXTERNAL_CAMPAIGN    	  VARCHAR(255) COMMENT '',
   EVAR27                     	  VARCHAR(255) COMMENT '',
   EVAR28_LIVE_CALL            	  VARCHAR(255) COMMENT '',
   EVAR29_PURCHASEID              VARCHAR(255) COMMENT '',                    	  
   EVAR3_CAMPAIGN_STACKING     	  VARCHAR(255) COMMENT '',
   EVAR30                     	  VARCHAR(255) COMMENT '',
   EVAR31_LEAD_FORM_ID         	  VARCHAR(255) COMMENT '',
   EVAR32_ORDER_FLOW_ID        	  VARCHAR(255) COMMENT '',
   EVAR33_CHECKOUT_ID          	  VARCHAR(255) COMMENT '',
   EVAR34                     	  VARCHAR(255) COMMENT '',
   EVAR35                     	  VARCHAR(255) COMMENT '',
   EVAR36_TRANSACTIONID        	  VARCHAR(255) COMMENT '',
   EVAR37                     	  VARCHAR(255) COMMENT '',
   EVAR38                     	  VARCHAR(255) COMMENT '',
   EVAR39_SITE_TYPE               VARCHAR(255) COMMENT '',
   ...
   EVAR8_VISITOR_TYPE          	  VARCHAR(255) COMMENT '',
   ...
   PROP10_CUSTOM_LINK             VARCHAR(255) COMMENT '',
   ...
   PROP41_LEAD_FORM_FIELD         VARCHAR(255) COMMENT '',
   PROP42_ORDER_FORM_FIELD        VARCHAR(255) COMMENT '',
   PROP43_CHECKOUT_FORM_FIELD     VARCHAR(255) COMMENT '',
   PROP44_SITE_TYPE	              VARCHAR(255) COMMENT '',
   PROP45_PAGE_TYPE	              VARCHAR(255) COMMENT '',
