...
#                    and create smith_language_tbl in smith layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_LANGUAGES_TBL}" \
     "${SMITH_LANGUAGES_TBL}" \
...
# Deriving languages table at Smith layer
...
#        -hivevar dtm_created="$dtm_created" \
 #       -hivevar hive_database_name_smith="${HIVE_DATABASE_NAME_SMITH}" \
  #      -hivevar smith_languages_tbl="${SMITH_LANGUAGES_TBL}" \
   #     -hivevar hive_database_name_incoming="${HIVE_DATABASE_NAME_INCOMING}" \
	#	-hivevar incoming_languages_tbl="${INCOMING_LANGUAGES_TBL}" \
