...
function fn_module_setup(){
  ...
  fn_module_create_hive_table_data_layer_directory_structure \
    "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_STAGING}" \
    "${INCOMING_HIT_DATA_STOCK36_RAW_TBL}" \
    "${BOOLEAN_FALSE}" \
    "${log_file_path}"
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_STAGING}/${INCOMING_HIT_DATA_STOCK36_RAW_TBL}" \
     "${INCOMING_HIT_DATA_STOCK36_RAW_TBL}" \
