...
#                    and create smith_optimum_event_list_tbl in smith layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_OPTIMUM_EVENT_LIST_TBL}" \
     "${SMITH_OPTIMUM_EVENT_LIST_TBL}" \
...
# Preparing optimum event list table at Smith layer  
function fn_module_prepare(){
  ...
  fn_copy_from_hdfs \
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_OPTIMUM_EVENT_LIST_TBL}/Optimum_Event_List.txt" \
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_OPTIMUM_EVENT_LIST_TBL}" \
     "${BOOLEAN_FALSE}" \
     "${BOOLEAN_FALSE}" \
     "${log_file_path}"
