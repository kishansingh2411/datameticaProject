...
#                    and create gold_opt_hit_data_tbl in gold layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_GOLD_SUBJECT_AREA}/${GOLD_OPT_HIT_DATA_TBL}" \
     "${GOLD_OPT_HIT_DATA_TBL}" \
...
function fn_module_transform(){
    ...
    pig -useHCatalog -p suite_name=$suite_name \
		...
		-p gold_opt_hit_data_tbl="${HIVE_TABLE_PREFIX}${GOLD_OPT_HIT_DATA_TBL}" \
