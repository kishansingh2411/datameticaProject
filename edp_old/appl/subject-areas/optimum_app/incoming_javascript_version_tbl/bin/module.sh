...
#   Purpose:    : Functions to prepare Javascript_version table in Incoming layer
#                 1. Executes setup function to create Search_engines table in Incoming Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_JAVASCRIPT_VERSION_TBL}" \
     "${INCOMING_JAVASCRIPT_VERSION_TBL}" \
...
#Transforming the Javascript_version table at Incoming layer
