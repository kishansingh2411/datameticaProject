...
#                    and create work_techs_tbl in work layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA_DATA}/${WORK_TECHS_TBL}" \
     "${WORK_TECHS_TBL}" \
...
function fn_module_prepare(){   
 ...
 #Sqoop EDP_TECHS_TBL table data
   ...
   then
      fn_log_error "Failed while recreating the table ${WORK_TECHS_TBL}" "${log_file_path}"
      return $exit_code
   fi
