...
#                    and create incoming_housemaster_tbl in incoming layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_DATA}/${INCOMING_HOUSEMASTER_TBL}" \
     "${INCOMING_HOUSEMASTER_TBL}" \
...
#Preparing incoming housemaster table.
function fn_module_prepare(){
  ...
  #Sqoop EDP_HOUSEMASTER table data
