...
#                 1. Executes setup function to prepare incoming_boxinvtry_tbl table in incoming layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_DATA}/${INCOMING_BOXINVTRY_TBL}" \
     "${INCOMING_BOXINVTRY_TBL}" \
...
#Preparing incoming boxinventry table.
function fn_module_prepare(){
  ...
  #Sqoop EDP_BOXINVTRY table data
