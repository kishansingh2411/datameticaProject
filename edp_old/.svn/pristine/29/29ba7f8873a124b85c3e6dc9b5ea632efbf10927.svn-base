...
#   Purpose:    : Functions to prepare Error_hit_data table in Incoming layer
#                 1. Executes setup function to create Error_hit_data table in Incoming Layer.
