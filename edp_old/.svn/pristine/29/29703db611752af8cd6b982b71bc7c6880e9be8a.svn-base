...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_KOM_FACT}/${SMITH_KOM_UNIFIED_OPTIMUM_USAGE_TBL}" \
     "${SMITH_KOM_UNIFIED_OPTIMUM_USAGE_TBL}" \
...
fn_module_transform(){
   ...
   fn_load_smith_fact_tables \
         ...
         "${HIVE_DATABASE_NAME_SMITH}" \
         "${HIVE_TABLE_PREFIX}${SMITH_KOM_UNIFIED_OPTIMUM_USAGE_TBL}" \
         "${hive_script_path}" \
         "${log_file_path}" \
         "${HIVESERVER2_URL}" \
         "${HIVE_USENAME}" \
...
#      -hivevar smith_kom_unified_optimum_usage=${SMITH_KOM_UNIFIED_OPTIMUM_USAGE_TBL} \
