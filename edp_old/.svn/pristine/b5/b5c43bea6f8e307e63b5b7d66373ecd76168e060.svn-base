...
success_message="Successfully loaded data to work A_DOM_NSN_IN_USAGE table"  
failure_message="Failed while loading data to work A_DOM_NSN_IN_USAGE table, Quitting the process." 
fn_handle_exit_code "${exit_code}" "${success_message}" "${failure_message}" "${BOOLEAN_TRUE}" "${executor_log_file}"
...
success_message="Successfully loaded data to work A_DOM_NSN_OUT_USAGE table"  
failure_message="Failed while loading data to work A_DOM_NSN_OUT_USAGE table, Quitting the process." 
fn_handle_exit_code "${exit_code}" "${success_message}" "${failure_message}" "${BOOLEAN_TRUE}" "${executor_log_file}"
...
success_message="Successfully loaded data to work A_INT_NSN_CALL_USAGE table"  
failure_message="Failed while loading data to work A_INT_NSN_CALL_USAGE table, Quitting the process." 
fn_handle_exit_code "${exit_code}" "${success_message}" "${failure_message}" "${BOOLEAN_TRUE}" "${executor_log_file}"
...
success_message="Successfully loaded data to work A_INT_RAD_CALL_USAGE table"  
failure_message="Failed while loading data to work A_INT_RAD_CALL_USAGE table, Quitting the process." 
fn_handle_exit_code "${exit_code}" "${success_message}" "${failure_message}" "${BOOLEAN_TRUE}" "${executor_log_file}"
...
success_message="Successfully loaded data to work A_VMA_NSN_CALL_USAGE table"  
failure_message="Failed while loading data to work A_VMA_NSN_CALL_USAGE table, Quitting the process." 
fn_handle_exit_code "${exit_code}" "${success_message}" "${failure_message}" "${BOOLEAN_TRUE}" "${executor_log_file}"
