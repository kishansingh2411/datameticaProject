...
#   Purpose:    : Functions to prepare Period table in Incoming layer
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_PERIOD_TBL}" \
     "${INCOMING_PERIOD_TBL}" \
...
#Preparing Period table at incoming layer
function fn_module_prepare(){
  ...
  fn_copy_from_local \
     "${SUBJECT_AREA_HOME}/metadata/D_PERIOD.txt" \
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_PERIOD_TBL}" \
     "${BOOLEAN_FALSE}" \
     "${BOOLEAN_FALSE}" \
     "${log_file_path}"
