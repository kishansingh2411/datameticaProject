...
SELECT
	...
	if(if(COALESCE(INCOMING_RSDVR_SCHEDULE.STARTDATE_STARTTIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.STARTDATE_STARTTIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0 OR (GOLD_RSDVR_SCHEDULE_LAST_REC.OP_TYPE ='D' AND to_date(INCOMING_RSDVR_SCHEDULE.LOADTIME) = to_date('${hivevar:dtm_end}')),'Y','N' ) as STARTDATE_STARTTIME_IND,
	if(if(COALESCE(INCOMING_RSDVR_SCHEDULE.DS_STARTTIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.DS_STARTTIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0 OR (GOLD_RSDVR_SCHEDULE_LAST_REC.OP_TYPE ='D' AND to_date(INCOMING_RSDVR_SCHEDULE.LOADTIME) = to_date('${hivevar:dtm_end}')),'Y','N' ) as DS_STARTTIME_IND,
	if(if(COALESCE(INCOMING_RSDVR_SCHEDULE.LAST_UPDATED,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.LAST_UPDATED,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0 OR (GOLD_RSDVR_SCHEDULE_LAST_REC.OP_TYPE ='D' AND to_date(INCOMING_RSDVR_SCHEDULE.LOADTIME) = to_date('${hivevar:dtm_end}')),'Y','N' ) as LAST_UPDATED_IND,
	IF(GOLD_RSDVR_SCHEDULE_LAST_REC.CALLSIGN IS NOT NULL AND  ( IF(COALESCE(INCOMING_RSDVR_SCHEDULE.ADULTLANG,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.ADULTLANG,'*'),1,0) = 0  OR IF (COALESCE(INCOMING_RSDVR_SCHEDULE.ADULTTHEME,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.ADULTTHEME,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.ANIMATED,'*') =  COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.ANIMATED,'*'),1,0) = 0  OR IF (COALESCE(INCOMING_RSDVR_SCHEDULE.BLACKWHITE,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.BLACKWHITE,'*'),1,0) = 0  OR IF (COALESCE(INCOMING_RSDVR_SCHEDULE.CLOSEDCAPTION,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.CLOSEDCAPTION,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.HALFSTARS,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.HALFSTARS,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.HDTV,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.HDTV,'*'),1,0) = 0 OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.ISMOVIE,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.ISMOVIE,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.LIVE,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.LIVE,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.LONG_DESC,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.LONGDESC,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.LONG_TITLE,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.LONGTITLE,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.MPAA_RATING,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.MPAARATING,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.NUDITY,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.NUDITY,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.RERUN,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.RERUN,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.SAP,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.SAP,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.SHORT_DESC,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.SHORTDESC,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.SHORT_TITLE,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.SHORTTITLE,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.STEREO,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.STEREO,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.SURROUND,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.SURROUND,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.THEME_IDS,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.THEMEIDS,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.TV_RATING,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.TVRATING,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.VIOLENCE,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.VIOLENCE,'*'),1,0) = 0  OR IF(COALESCE(INCOMING_RSDVR_SCHEDULE.CVC_CALLSIGN,'*') = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.CVCCALLSIGN,'*'),1,0) = 0  OR  if(COALESCE(INCOMING_RSDVR_SCHEDULE.STARTDATE_STARTTIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.STARTDATE_STARTTIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0 OR if(COALESCE(INCOMING_RSDVR_SCHEDULE.DS_STARTTIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.DS_STARTTIME,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0  OR if(COALESCE(INCOMING_RSDVR_SCHEDULE.LAST_UPDATED,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')) = COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.LAST_UPDATED,to_utc_timestamp(${hivevar:default_date},'YYYY-MM-DD HH:MM:SS')),1,0) = 0 OR (COALESCE(GOLD_RSDVR_SCHEDULE_LAST_REC.OP_TYPE,'*') = 'D' AND TO_DATE(LOADTIME) = TO_DATE('${hivevar:dtm_end}')) ),TRUE,FALSE ) AS CHANGEDFLAG,
