...
INSERT INTO TABLE ${hivevar:hive_database_name_gold}.${hivevar:gold_rsdvr_preferences_delta} 
	PARTITION (LOAD_DATE)
SELECT 
	...
	GOLD_RSDVR_PREFERENCES_LAST_REC.CREATE_TIME_IND,
	...
	WORK_RSDVR_PREFERENCES_DELETE_DEDUP.OP_TYPE,
	WORK_RSDVR_PREFERENCES_DELETE_DEDUP.DTM_CREATED,
	GOLD_RSDVR_PREFERENCES_LAST_REC.RSDVR_PREFERENCES_DELTA_SEQ,
	DATE_FORMAT('${hivevar:source_date}','yyyy-MM-dd') as LOAD_DATE
FROM 
	${hivevar:hive_database_name_gold}.${hivevar:gold_rsdvr_preferences_last_rec} GOLD_RSDVR_PREFERENCES_LAST_REC INNER JOIN ${hivevar:hive_database_name_work}.${hivevar:work_rsdvr_preferences_delete_dedup} WORK_RSDVR_PREFERENCES_DELETE_DEDUP 
ON
...
WHERE
	GOLD_RSDVR_PREFERENCES_LAST_REC.RSDVR_PREFERENCES_DELTA_SEQ=WORK_RSDVR_PREFERENCES_DELETE_DEDUP.RSDVR_PREFERENCES_DELTA_SEQ		
;