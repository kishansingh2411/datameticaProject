...
#   Purpose:    : Functions to prepare Country table in Incoming layer
#                 1. Executes setup function to create Country table in Incoming Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_COUNTRY_TBL}" \
     "${INCOMING_COUNTRY_TBL}" \
...
#Transforming the Country table at Incoming layer
