...
#                    and create smith_optimum_suite_tbl in smith layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_OPTIMUM_SUITE_TBL}" \
     "${SMITH_OPTIMUM_SUITE_TBL}" \
...
# Preparing optimum suite table at Smith layer
function fn_module_prepare(){
  ...
  fn_copy_from_hdfs \
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_OPTIMUM_SUITE_TBL}/Optimum_Suite.txt" \
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_OPTIMUM_SUITE_TBL}" \
     "${BOOLEAN_FALSE}" \
     "${BOOLEAN_FALSE}" \
     "${log_file_path}"
