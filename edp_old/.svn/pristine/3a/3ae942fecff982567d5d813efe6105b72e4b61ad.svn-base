...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_REQUESTS_SEQ_TBL}" \
     "${WORK_RSDVR_REQUESTS_SEQ_TBL}" \
...
#Preparing work_rsdvr_requests_seq_tbl table.
function fn_module_transform(){
	...
	target_dir="${DATA_LAYER_DIR_WORK_SUBJECT_AREA}/${WORK_RSDVR_REQUESTS_SEQ_TBL}/*"
    ...
    pig -useHCatalog -Ddfs.blocksize=${DFS_BLOCKSIZE} \
      ...
      -p work_rsdvr_requests_tmp_tbl=${WORK_RSDVR_REQUESTS_TMP_TBL} \
      -p work_rsdvr_requests_seq_tbl=${WORK_RSDVR_REQUESTS_SEQ_TBL} \
