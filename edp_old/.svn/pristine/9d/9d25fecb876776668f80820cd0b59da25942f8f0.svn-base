...
#   Purpose:    : Functions to prepare Operating_systems table in Incoming layer
#                 1. Executes setup function to create Operating_systems table in Incoming Layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_OPERATING_SYSTEMS_TBL}" \
     "${INCOMING_OPERATING_SYSTEMS_TBL}" \
...
#Transforming the Operating_systems table at Incoming layer
