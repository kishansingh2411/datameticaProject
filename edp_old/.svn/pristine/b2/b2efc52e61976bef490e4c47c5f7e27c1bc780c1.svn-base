...
#                    and create smith_period_tbl in smith layer.
...
function fn_module_setup(){
  ...
  fn_create_hive_table \
     ...
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_PERIOD_TBL}" \
     "${SMITH_PERIOD_TBL}" \
...
# Preparing period table at Smith layer
function fn_module_prepare(){
  ...
  fn_copy_from_hdfs \
     "${DATA_LAYER_DIR_INCOMING_SUBJECT_AREA_LOOKUP}/${INCOMING_PERIOD_TBL}/D_PERIOD.txt" \
     "${DATA_LAYER_DIR_SMITH_SUBJECT_AREA_DIMENSION}/${SMITH_PERIOD_TBL}" \
     "${BOOLEAN_FALSE}" \
     "${BOOLEAN_FALSE}" \
     "${log_file_path}"
