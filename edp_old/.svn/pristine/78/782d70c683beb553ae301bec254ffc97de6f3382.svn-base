...
select 
	...
	GOLD_RSDVR_PREFERENCES_LAST_REC.DTM_CREATED,
	GOLD_RSDVR_PREFERENCES_LAST_REC.LOAD_DATE,
    ...
    case when WORK_RSDVR_PREFERENCES_DELETE_DEDUP.HOME_ID IS NOT NULL AND WORK_RSDVR_PREFERENCES_DELETE_DEDUP.MAC_ADDRESS IS NOT NULL AND WORK_RSDVR_PREFERENCES_DELETE_DEDUP.SERIAL_NUMBER IS NOT NULL AND WORK_RSDVR_PREFERENCES_DELETE_DEDUP.SYST IS NOT NULL then  current_timestamp else GOLD_RSDVR_PREFERENCES_LAST_REC.DTM_LAST_MODIFIED end as DTM_LAST_MODIFIED,
	case when WORK_RSDVR_PREFERENCES_DELETE_DEDUP.HOME_ID IS NOT NULL AND WORK_RSDVR_PREFERENCES_DELETE_DEDUP.MAC_ADDRESS IS NOT NULL AND WORK_RSDVR_PREFERENCES_DELETE_DEDUP.SERIAL_NUMBER IS NOT NULL AND WORK_RSDVR_PREFERENCES_DELETE_DEDUP.SYST IS NOT NULL then  current_timestamp else GOLD_RSDVR_PREFERENCES_LAST_REC.DTM_LAST_UPDATED end  as DTM_LAST_UPDATED
FROM 
