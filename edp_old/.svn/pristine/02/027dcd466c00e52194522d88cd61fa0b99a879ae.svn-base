...
--#   Purpose:    : Build work_rsdvr_schedule_delete table 
...
SELECT 
	...
	'D'                                                          AS OP_TYPE,
	GOLD_RSDVR_SCHEDULE_LAST_REC.DTM_CREATED                     AS DTM_CREATED,
...
AND 
	TO_DATE(WORK_RSDVR_SCHEDULE_TMP.LOADTIME) < to_date('${hivevar:DTM_START}');
